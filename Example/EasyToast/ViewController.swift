...
class ViewController: UIViewController {
    ...
    @objc func showToast() {
        ...
        self.view.showToast("Dismiss on tap toast", position: .top, popTime: kToastNoPopTime, dismissOnTap: true, bgColor: UIColor.red.withAlphaComponent(0.7), textColor: UIColor.white, font: UIFont.systemFont(ofSize: 19))
